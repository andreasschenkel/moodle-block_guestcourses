...
$string['showinvisible_desc'] = 'Should not be used in productiv moodle because name of course will be visible! If activated then courses that are hidden are integrated in the list of shown guestcourses. (capability "cap block/guestcourses:viewinvisible" is also needed)';
