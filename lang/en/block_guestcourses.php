...
$string['showinvisible'] = 'Show invisible courses. cap block/guestcourses:viewinvisible is needed. (should not be used in productiv moodle because name of hidden course will be visible!)';
